...
import asGraph from '../../../previews/dashboards/asset-studio-graph.json';
import asHub from '../../../previews/dashboards/asset-studio-hub.json';
...
const CONSUMERS: ConsumerEntry[] = [
  { key: 'asset-studio', label: 'Asset Studio', graph: asGraph as unknown as RawGraph, hub: asHub as unknown as RawHub },
];
const DEFAULT_CONSUMER = 'asset-studio';
